...
void verificar_archivo_tarea(tarea_Mongo*);
void procesar_tarea(tarea_Mongo*);
void informar_falta_archivo(tarea_Mongo*, char*);
void procesar_falta_archivo(tarea_Mongo*,char*);
